...
function Products({dataproducts,databrands,datacategories}) {
    ...
    function switchProduct(params, value) {
        axios.put('/products/switch/' + params.id, { status: value },{
            headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
                Accept: "application/json",
            },
    ...
    const columns = [
        ...
        { field: 'price', headerName: "Price", width: 100, editable: true, valueFormatter: formatPrice },
        { field: 'discount', headerName: "Discount", width: 100, editable: true, valueFormatter: formatDiscount },
        ...
        },
        {
            ...
            renderCell: (params) => (
                ...
                onChange={(e) => switchProduct(params, e.target.checked ? 1 : 0)}
        ...
        },
        {
            ...
            renderCell: (params) => {
                ...
                return (
                    <a className="btn btn-sm btn-warning" href={`/products/${productId}`}>Edit</a>
                );
            }
        }
    ];
                ...
                <div className="row">
                    <div className="col-md-9">
                        <div className="row">
                            ...
                            <div className="col-md-2">
                                {create == true && (
                                    <button className='btn btn-sm btn-primary' onClick={(e) => SubmitProduct()}>Store</button>
                                )}
                            </div>
                        </div>
                        {create == true && (
                            <>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-3">
                                        <label>Tồn kho :</label>
                                        <input type="number" className="form-control" onChange={(e) => setInstock(e.target.value)} />
                                    </div>
                                </div>
                                <div className="row mt-2">
                                    ...
                                    <div className="col-md-3">
                                        <label>Brands:</label>
                                        <select name="brandId" defaultValue={0} className="form-control" value={idBrand} onChange={(e) => setIdBrand(e.target.value)}>
